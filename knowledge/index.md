# Knowledge Index -- Algron Coach

Alle Dateien werden on demand geladen -- NICHT bei Sessionstart.

| Datei | Inhalt | Genutzt von |
|-------|--------|-------------|
| `ceo-transition.md` | Führung, 10x-Denken, Founder-Transition, E-Myth, Theory of Constraints | Coach, Analyst, Horizon Scout |
| `saas-strategy.md` | Diversifikation, Moats, Legal-Tech-Markt, Klumpenrisiko, Workflow Moat | Coach, Horizon Scout |
